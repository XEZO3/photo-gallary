...
<div class="d-flex" id="wrapper">
            ...
            <div class="w3-sidebar w3-bar-block w3-border-right" style="display:none" id="mySidebar">
                  ...
                  <?php foreach($category as $row): ?>
                  <a href="<?=PATH?>home/categoryselect/<?=$row['id']?>" class="w3-bar-item w3-button"><?=$row["name_$lang"]?></a>
            ...
            <div id="page-content-wrapper">
                ...
                <header class="header" style="background-color:#F4F4F4 ;">
                    ...
                    <button class="btn" onclick="w3_open()" style="background-color: blue;padding-left:0">
